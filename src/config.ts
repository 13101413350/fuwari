...
export const siteConfig: SiteConfig = {
  ...
  banner: {
    enable: true,
    src: 'https://eo-r2.afo.im/myblog/img/222.webp',   // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const profileConfig: ProfileConfig = {
  avatar: 'https://eo-r2.afo.im/myblog/img/111.webp',  // Relative to the /src directory. Relative to the /public directory if it starts with '/'
  name: '乐子人',
